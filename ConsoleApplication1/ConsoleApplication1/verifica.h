...
int verificaresultado(char conferematriz[3][3]) {
	...
	if (conferematriz[0][1] == 'X' && conferematriz[1][1] == 'X' && conferematriz[2][1] == 'X') {
		vencedor = 2;
	}
	if (conferematriz[0][2] == 'X' && conferematriz[1][2] == 'X' && conferematriz[2][2] == 'X') {
		vencedor = 2;
	}
	...
	if (conferematriz[0][1] == 'O' && conferematriz[1][1] == 'O' && conferematriz[2][1] == 'O') {
		vencedor = 1;
	}
	if (conferematriz[0][2] == 'O' && conferematriz[1][2] == 'O' && conferematriz[2][2] == 'O') {
		vencedor = 1;
	}
